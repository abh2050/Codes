...
print(solution.isWithinRange(100, -100, 100)) # Output: True


'''
Time Complexity: O(1) - Constant time, as it performs a simple comparison.
Space Complexity: O(1) - Constant space, as it doesn't use any extra space dependent on the input size.
'''
```