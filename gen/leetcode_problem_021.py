...
# return `True` if `num` falls within the interval (i.e., `lower <= num <= upper`), and `False` otherwise.
...
# Time Complexity: O(1) - Constant time, as it involves only comparisons.
...
print(solution.isWithinRange(-100, -100, -99)) # Output: True
