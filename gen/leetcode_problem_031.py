...
# Problem Description:
# Given a string `s` consisting of lowercase English letters, return the number of vowels present in the string.
...
Space Complexity: O(1). We use constant extra space to store the vowels and the count.
'''
...
print(solution.countVowels("banana")) # Output: 3
